        ...
        <main id="main" class="site-main">
            <div class="container">
                <div class="row row-even zero-horizontal-margin">
					<h3><?php echo($appName .  "  <span class='property-status-tag'>". "{$searchLocation} / {$searchType} / {$searchStatus}"); ?></span></h3>
					<?php 
					if(empty($propertySearch)){
						echo("<h2>We so sorry but we don't have a property(s) that match your requirements. </h2>");
					}else{
